<x-app-layout>
    <x-slot name="header">
        <h1 class="display-6"><b>Selamat datang di halaman Group Anda,</b> <b><strong> [User]</strong></b></h1>
    </x-slot>
        ...
        <div class="col-md ms-2">
            <div class="row row-gap-3 justify-content-center">
                ...
                <div class="col-md-3">
                    <div class="card" style="width: 18rem;">
                        <div class="position-relative">
                            <img src="/img/event3.jpg" class="card-img-top rounded-circle img-thumbnail position-absolute start-0 top-0 ms-2 mt-2" alt="..." style="width: 70px; height: 70px; object-fit: cover;">
                        </div>
                        <div class="card-body">
                            <div class="ms-5">
                                <h3 class="card-title ms-4"><strong>Brooklyn Group</strong></h3>
                            </div>
                            <div class="float-end">
                                <a href="#" class="btn" style="text-decoration: underline; text-decoration-color: #7879DF; text-decoration-thickness: 1.5px; text-underline-offset: 10px; font-weight:700; color:#7879DF">Lihat grup</a>
                            </div>
                ...
                <div class="col-md-3">
                    <div class="card" style="width: 18rem;">
                        <div class="position-relative">
                            <img src="/img/event1.png" class="card-img-top rounded-circle img-thumbnail position-absolute start-0 top-0 ms-2 mt-2" alt="..." style="width: 70px; height: 70px; object-fit: cover;">
                        </div>
                        <div class="card-body">
                            <div class="ms-5">
                                <h3 class="card-title ms-4"><strong>Insight Group</strong></h3>
                            </div>
                            <div class="float-end">
                                <a href="#" class="btn" style="text-decoration: underline; text-decoration-color: #7879DF; text-decoration-thickness: 1.5px; text-underline-offset: 10px; font-weight:700; color:#7879DF">Lihat grup</a>
                            </div>
                ...
                <div class="col-md-3">
                    <div class="card" style="width: 18rem;">
                        <div class="position-relative">
                            <img src="/img/event7.jpg" class="card-img-top rounded-circle img-thumbnail position-absolute start-0 top-0 ms-2 mt-2" alt="..." style="width: 70px; height: 70px; object-fit: cover;">
                        </div>
                        <div class="card-body">
                            <div class="ms-5">
                                <h3 class="card-title ms-4"><strong>Off-Road Group</strong></h3>
                            </div>
                            <div class="float-end">
                                <a href="#" class="btn" style="text-decoration: underline; text-decoration-color: #7879DF; text-decoration-thickness: 1.5px; text-underline-offset: 10px; font-weight:700; color:#7879DF">Lihat grup</a>
                            </div>
