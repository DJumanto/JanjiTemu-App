<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 p-2">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <!-- <x-application-full-logo class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" /> -->
                        <img src="{{ asset('img/janjitemu-full-logo-new.png') }}" alt="" class="h-16">
                    </a>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <button type="button" class="btn position-relative" style="background-color:#7879DF; color:white;">
                    ...
                    <!-- option1 : Notification Count -->
                    <!-- <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                        10
                        <span class="visually-hidden">unread messages</span>
                    </span> -->

                    <!-- option2 : Notification Sign-Only -->
